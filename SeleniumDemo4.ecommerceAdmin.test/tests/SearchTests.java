...
import SeleniumDemo4.ecommerceAdmin.test.pageObjects.ProductEditPage;
import SeleniumDemo4.ecommerceAdmin.test.pageObjects.ProductPage;
import SeleniumDemo4.ecommerceAdmin.test.pageObjects.SideBarPage;
...
import static SeleniumDemo4.ecommerceAdmin.test.pageObjects.ProductPage.EMPTY_PRODUCT_LIST_CSS;
import static SeleniumDemo4.ecommerceAdmin.test.pageObjects.ProductPage.PRODUCT_LIST_CSS;
...
//        sideBarPage.getProductList().click();
        ...
        assertEquals(productPage.getProductTitles().size(), 1,
        ...
        assertEquals(productPage.getProductTitles().size(), productPage.getProductList().size(),
                "Product litle has different size that product list!");
    ...
    public void testEditProductName() {
        ...
        assertTrue(isElementPresent(By.cssSelector(EMPTY_PRODUCT_LIST_CSS)),
                "Product list is not empty when searching for an invalid product name");
    }
}
