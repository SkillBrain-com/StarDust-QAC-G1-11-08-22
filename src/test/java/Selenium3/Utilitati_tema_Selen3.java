...
public class Utilitati_tema_Selen3 {
    ...
    public static ChromeDriver getMobileChromeDriver() throws InterruptedException {
        System.setProperty("webdriver.chrome.driver" , "drivers/chromedriver.exe" );
        ChromeOptions options = new ChromeOptions();
        Map<String,String> mobileMap= new HashMap<>();
        mobileMap.put("deviceName" , "PUNE NUMELE DEVICE-ului AICI");
