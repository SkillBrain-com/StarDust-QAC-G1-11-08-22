...
import static org.testng.Assert.*;
    ...
    public class Tema_SAWG_Labs {

    WebDriver driver;
//    private long cartItemName;
//    private long firstItemTitle;
//
...
//        List<WebElement> cartItems = (List<WebElement>) driver.findElement(By.className("cart_item"));
